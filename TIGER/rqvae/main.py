...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="../data/KuaiRand-1K/video_emb.parquet", help="Input data path.")
    ...
    parser.add_argument("--ckpt_dir", type=str, default="./ckpt/KuaiRand-1K", help="please specify output directory for model")
